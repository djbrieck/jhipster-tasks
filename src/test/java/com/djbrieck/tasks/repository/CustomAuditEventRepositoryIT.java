package com.djbrieck.tasks.repository;

import com.djbrieck.tasks.TasksApp;
import com.djbrieck.tasks.config.Constants;
import com.djbrieck.tasks.config.audit.AuditEventConverter;
import com.djbrieck.tasks.domain.PersistentAuditEvent;
...
import static com.djbrieck.tasks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
